...
def test_get_all_sets():
    ...
    expected_sets = [
            [Card(Suits.HEART, 3), Card(Suits.HEART, 3)],
            [Card(Suits.HEART, 2)],
            [Card(Suits.HEART, 1)],
        ]

    sets = get_all_sets(hand, 9)
...
def test_get_all_runs():
    ...
    expected_sets = [
            [Card(Suits.HEART, 3), Card(Suits.HEART, 2), Card(Suits.HEART, 1)],
            [Card(Suits.HEART, 2)],
        ]
